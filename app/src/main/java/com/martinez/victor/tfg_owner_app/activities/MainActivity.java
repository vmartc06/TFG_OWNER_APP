...
import com.martinez.victor.tfg_owner_app.utilities.Doctor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Normal loading of main activity
        ...
        editor.remove("appApiKey");
        editor.apply();
        Doctor.checkHealth(getApplicationContext());
    }
